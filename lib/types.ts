...
export type Analysis = {
  ...
  raw_hook_score: number | null;
  raw_cta_score: number | null;
  raw_urgency_score: number | null;
  raw_audience_score: number | null;
  raw_pain_score: number | null;
  raw_solution_score: number | null;
  raw_viral_score: number | null;
  raw_lead_gen_score: number | null;
